                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WORK5, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WORK5));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WORK5));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WORK5);
    ...
    case WM_COMMAND:
        {
			...
			case ID_32771:
				...
				break;
			case ID_32772:
				DialogBox(hInst, MAKEINTRESOURCE(IDD_DIALOG2), hWnd, About2);
				break;
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
