...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/myNot/myNot.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myNot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myNot.tcl
