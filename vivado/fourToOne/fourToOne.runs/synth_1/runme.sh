...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/fourToOne/fourToOne.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourToOne.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourToOne.tcl
