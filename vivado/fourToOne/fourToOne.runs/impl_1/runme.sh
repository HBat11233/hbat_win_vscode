...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/fourToOne/fourToOne.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourToOne.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourToOne.tcl -notrace
