...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/test2/test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bigWork.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bigWork.tcl
