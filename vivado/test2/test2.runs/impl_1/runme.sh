...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/test2/test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bigWork.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bigWork.tcl -notrace
