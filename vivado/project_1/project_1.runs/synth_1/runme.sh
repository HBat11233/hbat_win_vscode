...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw2led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw2led.tcl
