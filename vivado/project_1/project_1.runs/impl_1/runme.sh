...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw2led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw2led.tcl -notrace
