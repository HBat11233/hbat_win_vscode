...
HD_PWD='C:/Users/HBat/Documents/GitHub/hbat_win_vscode/vivado/myOr/myOr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myOr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myOr.tcl
