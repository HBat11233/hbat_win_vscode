...
HD_PWD='D:/hbat_win_vscode/vivado/test4/test4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moore.tcl
